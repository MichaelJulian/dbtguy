...
class TipsControllerTest < ActionController::TestCase
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post :create, tip: { caption: @tip.caption, do: @tip.do, dont: @tip.dont, quote: @tip.quote, situation: @tip.situation, title: @tip.title }
    end
  ...
  test "should update tip" do
    patch :update, id: @tip, tip: { caption: @tip.caption, do: @tip.do, dont: @tip.dont, quote: @tip.quote, situation: @tip.situation, title: @tip.title }
    assert_redirected_to tip_path(assigns(:tip))
  end
