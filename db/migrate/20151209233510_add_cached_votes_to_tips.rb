class AddCachedVotesToTips < ActiveRecord::Migration
  def self.up
    ...
    add_column :tips, :cached_weighted_total, :integer, :default => 0
    add_column :tips, :cached_weighted_average, :float, :default => 0.0
    ...
    add_index  :tips, :cached_weighted_total
    add_index  :tips, :cached_weighted_average
  ...
  def self.down
    remove_column :tips, :cached_votes_total
    remove_column :tips, :cached_votes_score
    remove_column :tips, :cached_votes_up
    remove_column :tips, :cached_votes_down
    remove_column :tips, :cached_weighted_score
    remove_column :tips, :cached_weighted_total
    remove_column :tips, :cached_weighted_average
  end
end
